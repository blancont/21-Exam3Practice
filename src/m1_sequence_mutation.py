...
def zero_changer(tuple_of_lists):
    ...
    for list_in_tuple in range(len(tuple_of_lists)):
        for index_of_list_in_tuple in range(len(tuple_of_lists[list_in_tuple])):
            if tuple_of_lists[list_in_tuple][index_of_list_in_tuple] == 0:
                tuple_of_lists[list_in_tuple][index_of_list_in_tuple] = replacement_number
